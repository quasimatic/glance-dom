...
export default [customLabel, containsText, exactText, value, className, attribute, nodeType, css, levelMatches, visibility, leafNodeTarget, inputAfter, containedNearScope, index, closest];